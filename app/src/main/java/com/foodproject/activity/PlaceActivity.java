...
public class PlaceActivity extends AppCompatActivity implements PlaceFeatureAdapter.OnPlaceClickListener,
    ...
    private RelativeLayout msellerchat;
    ...
    private void initComponents() {
        ...
        mText1 = findViewById(R.id.seller_name);
        ...
        msellerchat = findViewById(R.id.seller_chatting);
    }
    ...
    private void setupWidgets() {
        ...
        msellerchat.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
    ...
    @Override
    public void OnPlaceNoFavoriteClick(Feature products) {

    }

    @Override
    public void OnPlaceFavoriteClick(Feature products) {

    }

    @Override
    public void onTrendingClickListener(Feature product) {
