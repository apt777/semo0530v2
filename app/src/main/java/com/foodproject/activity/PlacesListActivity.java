...
public class PlacesListActivity extends AppCompatActivity implements SellerAdapter.OnPlaceClickListener{
...
//        GridLayoutManager llmProduct = new GridLayoutManager(this, 2);
        ...
        SellerAdapter mSellerAdapter = new SellerAdapter(this);
